...
const validationSchema = yup.object().shape({
    ...
    terms: yup.bool()
        .oneOf([true], 'Accept Terms & Conditions is required').required('Accept Terms & Conditions is required')
});
...
export const SignUpForm = () => {
    ...
    const { authState: { isAuth, }, signupWithEmailPassword, signInWithFacebook, signInWithGoogle } = useFirebaseAuthContext()
    ...
    const handleSignUp = (method: SignUpMethod, email?: string, password?: string) => {
        ...
        switch (method) {
            ...
            case SignUpMethod.EMAIL_AND_PASSWORD:
                return signupWithEmailPassword(email, password).then(() => history.replace(from))
            default:
                return null
        }
    }
            ...
            <div className={classes.form_container}>
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className={classes.terms}>
                        ...
                        />
                        <p>I agree to the <span className={classes.termsLink}>terms</span>  and <span className={classes.termsLink}>conditions</span> </p>
                    </div>
                    <p className={classes.termsLink} style={{ color: 'red', fontSize: '0.7rem' }}>{formik.touched.terms && formik.errors.terms}</p>
