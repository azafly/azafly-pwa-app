...
export type InsertNewUserMutation = { readonly __typename?: 'mutation_root' } & {
    readonly insert_users_one?: Maybe<
        { readonly __typename?: 'users' } & Pick<Users, 'created_at' | 'email' | 'email_verified' | 'id' | 'image_url' | 'phone' | 'firebase_id'>
    >;
};
...
export type UpdateUserMutation = { readonly __typename?: 'mutation_root' } & {
    readonly update_users?: Maybe<{ readonly __typename?: 'users_mutation_response' } & Pick<Users_Mutation_Response, 'affected_rows'>>;
};
...
export type GetUserTransactionsQuery = { readonly __typename?: 'query_root' } & {
    readonly transaction: ReadonlyArray<
        { readonly __typename?: 'transaction' } & Pick<Transaction, 'amount' | 'created_at' | 'id' | 'is_success_done' | 'name' | 'updated_at'> & {
                readonly payment_offer?: Maybe<
                    { readonly __typename?: 'payment_offer' } & Pick<
                        Payment_Offer,
                        | 'payment_status'
                        | 'source_amount'
                        | 'source_currency'
...
export type GetCurrentUserQuery = { readonly __typename?: 'query_root' } & {
    readonly users_by_pk?: Maybe<
        { readonly __typename?: 'users' } & Pick<Users, 'display_name' | 'email' | 'email_verified' | 'id' | 'image_url' | 'phone'>
    >;
};
...
export type GetCurrentUserByEmailQuery = { readonly __typename?: 'query_root' } & {
    readonly users: ReadonlyArray<
        { readonly __typename?: 'users' } & Pick<Users, 'display_name' | 'email' | 'email_verified' | 'firebase_id' | 'id' | 'image_url' | 'phone'>
    >;
};
...
export function useGetUserTransactionsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GetUserTransactionsQuery, GetUserTransactionsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useGetCurrentUserByEmailLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GetCurrentUserByEmailQuery, GetCurrentUserByEmailQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
