...
// import { useCountryList, Country } from '../../hooks';
...
// export const useDefaultCountrySelectProps = ({
//     options,
//     defaultOption,
//     getOptionDisabled,
//     getOptionLabel,
//     renderOption
// }: DefaultCountrySelectProps): Required<DefaultCountrySelectProps> => {
//     const { NIGERIA, popularSourceCountries } = useCountryList() || {};
//     const defaultProps: DefaultCountrySelectProps = {};
//     defaultProps['defaultOption'] = !defaultOption ? NIGERIA : defaultOption;
//     defaultProps['options'] = !options ? [NIGERIA, ...popularSourceCountries] : options;
...
//     defaultProps['getOptionLabel'] = !getOptionLabel ? (option: Country) => ` ${option.flag}  ${option.name}(${option.currency})` : getOptionLabel;
